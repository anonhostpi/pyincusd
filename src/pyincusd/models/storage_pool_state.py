...
class StoragePoolState(BaseModel):
    ...
    StoragePoolState
    """ # noqa: E501
    inodes: Optional[ResourcesStoragePoolInodes] = None
    space: Optional[ResourcesStoragePoolSpace] = None
    __properties: ClassVar[List[str]] = ["inodes", "space"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inodes
        if self.inodes:
            _dict['inodes'] = self.inodes.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inodes": ResourcesStoragePoolInodes.from_dict(obj["inodes"]) if obj.get("inodes") is not None else None,
            "space": ResourcesStoragePoolSpace.from_dict(obj["space"]) if obj.get("space") is not None else None
        })
        return _obj
