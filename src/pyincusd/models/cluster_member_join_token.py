...
class ClusterMemberJoinToken(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(default=None, description="The addresses of existing online cluster members", json_schema_extra={"examples": [["10.98.30.229:8443"]]})
    ...
    __properties: ClassVar[List[str]] = ["addresses", "expires_at", "fingerprint", "secret", "server_name"]
