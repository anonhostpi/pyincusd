...
class NetworkForwardGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[NetworkForward] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": NetworkForward.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
