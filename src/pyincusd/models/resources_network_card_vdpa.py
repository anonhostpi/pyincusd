...
class ResourcesNetworkCardVDPA(BaseModel):
    ...
    """ # noqa: E501
    device: Optional[StrictStr] = Field(default=None, description="Device identifier of the VDPA device")
    name: Optional[StrictStr] = Field(default=None, description="Name of the VDPA device")
    __properties: ClassVar[List[str]] = ["device", "name"]
