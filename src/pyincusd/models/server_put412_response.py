...
class ServerPut412Response(BaseModel):
    """
    ServerPut412Response
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["precondition failed"]})
    error_code: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [412]})
