...
class NetworkLoadBalancerStateGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[NetworkLoadBalancerState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": NetworkLoadBalancerState.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
