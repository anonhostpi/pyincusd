...
class ResourcesCPUAddressSizes(BaseModel):
    ...
    """ # noqa: E501
    physical_bits: Optional[StrictInt] = None
    virtual_bits: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["physical_bits", "virtual_bits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "physical_bits": obj.get("physical_bits"),
            "virtual_bits": obj.get("virtual_bits")
        })
        return _obj
