...
class InstanceStateNetworkCounters(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors_received": obj.get("errors_received"),
            "errors_sent": obj.get("errors_sent"),
            "packets_dropped_inbound": obj.get("packets_dropped_inbound"),
            "packets_dropped_outbound": obj.get("packets_dropped_outbound"),
