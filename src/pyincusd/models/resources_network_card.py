...
class ResourcesNetworkCard(BaseModel):
    ...
    """ # noqa: E501
    driver: Optional[StrictStr] = Field(default=None, description="Kernel driver currently associated with the card")
    ...
    numa_node: Optional[StrictInt] = Field(default=None, description="NUMA node the card is a part of")
    pci_address: Optional[StrictStr] = Field(default=None, description="PCI address (for PCI cards)")
