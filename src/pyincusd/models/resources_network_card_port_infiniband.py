...
class ResourcesNetworkCardPortInfiniband(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issm_device": obj.get("issm_device"),
            "issm_name": obj.get("issm_name"),
            "mad_device": obj.get("mad_device"),
            "mad_name": obj.get("mad_name"),
            "verb_device": obj.get("verb_device"),
            "verb_name": obj.get("verb_name")
        })
        return _obj
