...
------------- | ------------- | -------------
[**api_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#api_get) | **GET** / | Get the supported API endpoints
[**events_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#events_get) | **GET** /1.0/events | Get the event stream
[**resources_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#resources_get) | **GET** /1.0/resources | Get system resources information
[**server_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#server_get) | **GET** /1.0 | Get the server environment and configuration
[**server_get_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#server_get_untrusted) | **GET** /1.0?public | Get the server environment
[**server_patch**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#server_patch) | **PATCH** /1.0 | Partially update the server configuration
[**server_put**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerApi.md#server_put) | **PUT** /1.0 | Update the server configuration
...
[**ApiGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ApiGet200Response.md)
...
[**Event**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/Event.md)
...
[**ResourcesGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ResourcesGet200Response.md)
...
[**ServerGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerGet200Response.md)
...
[**ServerGetUntrusted200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerGetUntrusted200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **server** | [**ServerPut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/ServerPut.md)| Server configuration | 
 **target** | **str**| Cluster member name | [optional] 
