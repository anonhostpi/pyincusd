...
------------- | ------------- | -------------
[**cluster_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_get) | **GET** /1.0/cluster | Get the cluster configuration
[**cluster_groups_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_groups_post) | **POST** /1.0/cluster/groups | Create a cluster group.
[**cluster_member_delete**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_delete) | **DELETE** /1.0/cluster/members/{name} | Delete the cluster member
[**cluster_member_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_get) | **GET** /1.0/cluster/members/{name} | Get the cluster member
[**cluster_member_patch**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_patch) | **PATCH** /1.0/cluster/members/{name} | Partially update the cluster member
[**cluster_member_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_post) | **POST** /1.0/cluster/members/{name} | Rename the cluster member
[**cluster_member_put**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_put) | **PUT** /1.0/cluster/members/{name} | Update the cluster member
[**cluster_member_state_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_state_get) | **GET** /1.0/cluster/members/{name}/state | Get state of the cluster member
[**cluster_member_state_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_member_state_post) | **POST** /1.0/cluster/members/{name}/state | Evacuate or restore a cluster member
[**cluster_members_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_members_get) | **GET** /1.0/cluster/members | Get the cluster members
[**cluster_members_get_recursion1**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_members_get_recursion1) | **GET** /1.0/cluster/members?recursion&#x3D;1 | Get the cluster members
[**cluster_members_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_members_post) | **POST** /1.0/cluster/members | Request a join token
[**cluster_put**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#cluster_put) | **PUT** /1.0/cluster | Update the cluster configuration
[**clustering_update_cert**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterApi.md#clustering_update_cert) | **PUT** /1.0/cluster/certificate | Update the certificate for the cluster
...
[**ClusterGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterGet200Response.md)
...
------------- | ------------- | ------------- | -------------
 **cluster** | [**ClusterGroupsPost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterGroupsPost.md)| Cluster group to create | 
...
[**ClusterMemberGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMemberGet200Response.md)
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Path parameter: name | 
 **cluster** | [**ClusterMemberPut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMemberPut.md)| Cluster member configuration | 
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Path parameter: name | 
 **cluster** | [**ClusterMemberPost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMemberPost.md)| Cluster member rename request | 
...
[**ClusterMemberStateGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMemberStateGet200Response.md)
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Path parameter: name | 
 **cluster** | [**ClusterMemberStatePost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMemberStatePost.md)| Cluster member state | 
...
[**ClusterMembersGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMembersGet200Response.md)
...
[**ClusterMembersGetRecursion1200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMembersGetRecursion1200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cluster** | [**ClusterMembersPost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterMembersPost.md)| Cluster member add request | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cluster** | [**ClusterPut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterPut.md)| Cluster configuration | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cluster** | [**ClusterCertificatePut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/ClusterCertificatePut.md)| Cluster certificate replace request | 
