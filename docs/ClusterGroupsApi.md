...
------------- | ------------- | -------------
[**cluster_group_delete**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_group_delete) | **DELETE** /1.0/cluster/groups/{name} | Delete the cluster group.
[**cluster_group_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_group_get) | **GET** /1.0/cluster/groups/{name} | Get the cluster group
[**cluster_group_patch**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_group_patch) | **PATCH** /1.0/cluster/groups/{name} | Update the cluster group
[**cluster_group_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_group_post) | **POST** /1.0/cluster/groups/{name} | Rename the cluster group
[**cluster_group_put**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_group_put) | **PUT** /1.0/cluster/groups/{name} | Update the cluster group
[**cluster_groups_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_groups_get) | **GET** /1.0/cluster/groups | Get the cluster groups
[**cluster_groups_get_recursion1**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsApi.md#cluster_groups_get_recursion1) | **GET** /1.0/cluster/groups?recursion&#x3D;1 | Get the cluster groups
...
[**ClusterGroupGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupGet200Response.md)
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Path parameter: name | 
 **cluster_group** | [**ClusterGroupPut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupPut.md)| cluster group configuration | 
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Path parameter: name | 
 **name2** | [**ClusterGroupPost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupPost.md)| Cluster group rename request | 
...
[**ClusterGroupsGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsGet200Response.md)
...
[**ClusterGroupsGetRecursion1200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/ClusterGroupsGetRecursion1200Response.md)
