...
**entries** | [**List[NetworkZoneRecordEntry]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/NetworkZoneRecordEntry.md) | Entries in the record | [optional] 
