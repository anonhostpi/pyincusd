...
**vfs** | [**List[ResourcesGPUCard]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post8/docs/ResourcesGPUCard.md) | List of VFs (as additional GPU devices) | [optional] 
