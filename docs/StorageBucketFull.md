...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/StorageBucketBackup.md) | List of backups. | [optional] 
**config** | **object** | Storage bucket configuration map | [optional] 
**description** | **str** | Description of the storage bucket | [optional] 
**keys** | [**List[StorageBucketKey]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/StorageBucketKey.md) | List of keys. | [optional] 
