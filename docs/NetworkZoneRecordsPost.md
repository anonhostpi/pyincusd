...
**entries** | [**List[NetworkZoneRecordEntry]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post18/docs/NetworkZoneRecordEntry.md) | Entries in the record | [optional] 
