...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post17/docs/StorageVolumeSnapshot.md) | List of storage volume snapshots | [optional] 
