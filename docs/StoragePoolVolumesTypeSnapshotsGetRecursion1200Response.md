...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/StorageVolumeSnapshot.md) | List of storage volume snapshots | [optional] 
