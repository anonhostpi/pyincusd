...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post2/docs/StorageVolumeSnapshot.md) | List of storage volume snapshots | [optional] 
