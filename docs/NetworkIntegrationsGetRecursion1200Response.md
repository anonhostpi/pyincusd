...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkIntegration]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post21/docs/NetworkIntegration.md) | List of network integrations | [optional] 
