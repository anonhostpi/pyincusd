...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkIntegration]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post11/docs/NetworkIntegration.md) | List of network integrations | [optional] 
