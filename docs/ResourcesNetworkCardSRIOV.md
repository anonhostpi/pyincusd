...
**vfs** | [**List[ResourcesNetworkCard]**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ResourcesNetworkCard.md) | List of VFs (as additional Network devices) | [optional] 
