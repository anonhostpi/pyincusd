...
**vfs** | [**List[ResourcesNetworkCard]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post7/docs/ResourcesNetworkCard.md) | List of VFs (as additional Network devices) | [optional] 
