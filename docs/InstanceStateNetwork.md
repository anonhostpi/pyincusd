...
------------ | ------------- | ------------- | -------------
**addresses** | [**List[InstanceStateNetworkAddress]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/InstanceStateNetworkAddress.md) | List of IP addresses | [optional] 
**counters** | [**InstanceStateNetworkCounters**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post16/docs/InstanceStateNetworkCounters.md) |  | [optional] 
