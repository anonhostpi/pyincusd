...
------------ | ------------- | ------------- | -------------
**storage_pools** | [**Dict[str, StoragePoolState]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post15/docs/StoragePoolState.md) |  | [optional] 
**sysinfo** | [**ClusterMemberSysInfo**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post15/docs/ClusterMemberSysInfo.md) |  | [optional] 
