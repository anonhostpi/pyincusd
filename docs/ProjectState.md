...
------------ | ------------- | ------------- | -------------
**resources** | [**Dict[str, ProjectStateResource]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post5/docs/ProjectStateResource.md) | Allocated and used resources | [optional] [readonly] 
