...
------------ | ------------- | ------------- | -------------
**resources** | [**Dict[str, ProjectStateResource]**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ProjectStateResource.md) | Allocated and used resources | [optional] [readonly] 
