...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post12/docs/StorageBucketBackup.md) | List of storage bucket backups | [optional] 
