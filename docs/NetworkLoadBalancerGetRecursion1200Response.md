...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkLoadBalancer]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post21/docs/NetworkLoadBalancer.md) | List of network address load balancers | [optional] 
