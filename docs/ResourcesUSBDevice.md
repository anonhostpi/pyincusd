...
**interfaces** | [**List[ResourcesUSBDeviceInterface]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post9/docs/ResourcesUSBDeviceInterface.md) | List of USB interfaces | [optional] 
