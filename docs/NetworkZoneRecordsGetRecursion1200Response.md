...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkZoneRecord]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post19/docs/NetworkZoneRecord.md) | List of network zone records | [optional] 
