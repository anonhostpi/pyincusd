...
------------ | ------------- | ------------- | -------------
**devices** | [**List[ResourcesSerialDevice]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ResourcesSerialDevice.md) | List of serial devices | [optional] 
