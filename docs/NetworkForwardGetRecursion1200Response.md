...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkForward]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post12/docs/NetworkForward.md) | List of network address forwards | [optional] 
