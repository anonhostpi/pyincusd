...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/StorageVolumeBackup.md) | List of storage volume backups | [optional] 
