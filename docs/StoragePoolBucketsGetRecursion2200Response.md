...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketFull]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post6/docs/StorageBucketFull.md) | List of storage pool buckets | [optional] 
