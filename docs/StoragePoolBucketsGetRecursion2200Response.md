...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketFull]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post1/docs/StorageBucketFull.md) | List of storage pool buckets | [optional] 
