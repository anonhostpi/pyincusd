...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketKey]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post5/docs/StorageBucketKey.md) | List of storage pool bucket keys | [optional] 
