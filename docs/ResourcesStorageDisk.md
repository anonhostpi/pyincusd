...
**partitions** | [**List[ResourcesStorageDiskPartition]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ResourcesStorageDiskPartition.md) | List of partitions | [optional] 
