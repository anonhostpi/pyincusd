...
**egress** | [**List[NetworkACLRule]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post10/docs/NetworkACLRule.md) | List of egress rules (order independent) | [optional] 
**ingress** | [**List[NetworkACLRule]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post10/docs/NetworkACLRule.md) | List of ingress rules (order independent) | [optional] 
