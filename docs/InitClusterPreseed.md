...
**member_config** | [**List[ClusterMemberConfigKey]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post21/docs/ClusterMemberConfigKey.md) | List of member configuration keys (used during join) | [optional] 
