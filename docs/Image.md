...
------------ | ------------- | ------------- | -------------
**aliases** | [**List[ImageAlias]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post1/docs/ImageAlias.md) | List of aliases | [optional] 
...
**update_source** | [**ImageSource**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post1/docs/ImageSource.md) |  | [optional] 
