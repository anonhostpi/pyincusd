...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkAddressSet]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post11/docs/NetworkAddressSet.md) | List of network address sets | [optional] 
