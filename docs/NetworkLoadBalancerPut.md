...
------------ | ------------- | ------------- | -------------
**backends** | [**List[NetworkLoadBalancerBackend]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post1/docs/NetworkLoadBalancerBackend.md) | Backends (optional) | [optional] 
...
**ports** | [**List[NetworkLoadBalancerPort]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post1/docs/NetworkLoadBalancerPort.md) | Port forwards (optional) | [optional] 
