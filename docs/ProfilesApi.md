...
------------- | ------------- | -------------
[**profile_delete**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profile_delete) | **DELETE** /1.0/profiles/{name} | Delete the profile
[**profile_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profile_get) | **GET** /1.0/profiles/{name} | Get the profile
[**profile_patch**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profile_patch) | **PATCH** /1.0/profiles/{name} | Partially update the profile
[**profile_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profile_post) | **POST** /1.0/profiles/{name} | Rename the profile
[**profile_put**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profile_put) | **PUT** /1.0/profiles/{name} | Update the profile
[**profiles_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profiles_get) | **GET** /1.0/profiles | Get the profiles
[**profiles_get_recursion1**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profiles_get_recursion1) | **GET** /1.0/profiles?recursion&#x3D;1 | Get the profiles
[**profiles_post**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesApi.md#profiles_post) | **POST** /1.0/profiles | Add a profile
...
[**ProfileGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfileGet200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **profile** | [**ProfilePut**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilePut.md)| Profile configuration | 
 **project** | **str**| Project name | [optional] 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **profile** | [**ProfilePost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilePost.md)| Profile rename request | 
 **project** | **str**| Project name | [optional] 
...
[**ProfilesGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesGet200Response.md)
...
[**ProfilesGetRecursion1200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesGetRecursion1200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **profile** | [**ProfilesPost**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post3/docs/ProfilesPost.md)| Profile | 
 **project** | **str**| Project name | [optional] 
