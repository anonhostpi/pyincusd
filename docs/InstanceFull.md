...
**backups** | [**List[InstanceBackup]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post6/docs/InstanceBackup.md) | List of backups. | [optional] 
...
**snapshots** | [**List[InstanceSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post6/docs/InstanceSnapshot.md) | List of snapshots. | [optional] 
**state** | [**InstanceState**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post6/docs/InstanceState.md) |  | [optional] 
