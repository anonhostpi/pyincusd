...
------------ | ------------- | ------------- | -------------
**address_sizes** | [**ResourcesCPUAddressSizes**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ResourcesCPUAddressSizes.md) |  | [optional] 
**cache** | [**List[ResourcesCPUCache]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ResourcesCPUCache.md) | List of CPU caches | [optional] 
**cores** | [**List[ResourcesCPUCore]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ResourcesCPUCore.md) | List of CPU cores | [optional] 
