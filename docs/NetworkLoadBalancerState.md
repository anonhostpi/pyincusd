...
------------ | ------------- | ------------- | -------------
**backend_health** | [**Dict[str, NetworkLoadBalancerStateBackendHealth]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post7/docs/NetworkLoadBalancerStateBackendHealth.md) |  | [optional] 
