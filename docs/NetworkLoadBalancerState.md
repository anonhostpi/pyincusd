...
------------ | ------------- | ------------- | -------------
**backend_health** | [**Dict[str, NetworkLoadBalancerStateBackendHealth]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post8/docs/NetworkLoadBalancerStateBackendHealth.md) |  | [optional] 
