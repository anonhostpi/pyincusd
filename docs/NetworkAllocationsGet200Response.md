...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkAllocations]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post4/docs/NetworkAllocations.md) | List of network allocations used by a consuming entity | [optional] 
