...
------------ | ------------- | ------------- | -------------
**aliases** | [**List[ImageAlias]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post8/docs/ImageAlias.md) | Aliases to add to the image | [optional] 
...
**source** | [**ImagesPostSource**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post8/docs/ImagesPostSource.md) |  | [optional] 
