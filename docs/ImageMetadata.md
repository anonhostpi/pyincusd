...
**templates** | [**Dict[str, ImageMetadataTemplate]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post13/docs/ImageMetadataTemplate.md) | Template for files in the image | [optional] 
