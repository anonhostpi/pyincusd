...
**templates** | [**Dict[str, ImageMetadataTemplate]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post2/docs/ImageMetadataTemplate.md) | Template for files in the image | [optional] 
