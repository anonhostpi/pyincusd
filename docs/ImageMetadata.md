...
**templates** | [**Dict[str, ImageMetadataTemplate]**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageMetadataTemplate.md) | Template for files in the image | [optional] 
