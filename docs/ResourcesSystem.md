...
------------ | ------------- | ------------- | -------------
**chassis** | [**ResourcesSystemChassis**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post15/docs/ResourcesSystemChassis.md) |  | [optional] 
**family** | **str** | System family | [optional] 
**firmware** | [**ResourcesSystemFirmware**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post15/docs/ResourcesSystemFirmware.md) |  | [optional] 
**motherboard** | [**ResourcesSystemMotherboard**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post15/docs/ResourcesSystemMotherboard.md) |  | [optional] 
