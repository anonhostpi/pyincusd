...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post11/docs/StorageVolumeBackup.md) | List of backups. | [optional] 
...
**snapshots** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post11/docs/StorageVolumeSnapshot.md) | List of snapshots. | [optional] 
**state** | [**StorageVolumeState**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post11/docs/StorageVolumeState.md) |  | [optional] 
