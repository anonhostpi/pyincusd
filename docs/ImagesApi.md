...
------------- | ------------- | -------------
[**image_alias_delete**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_alias_delete) | **DELETE** /1.0/images/aliases/{name} | Delete the image alias
[**image_alias_get**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_alias_get) | **GET** /1.0/images/aliases/{name} | Get the image alias
[**image_alias_get_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_alias_get_untrusted) | **GET** /1.0/images/aliases/{name}?public | Get the public image alias
[**image_delete**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_delete) | **DELETE** /1.0/images/{fingerprint} | Delete the image
[**image_export_get**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_export_get) | **GET** /1.0/images/{fingerprint}/export | Get the raw image file(s)
[**image_export_get_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_export_get_untrusted) | **GET** /1.0/images/{fingerprint}/export?public | Get the raw image file(s)
[**image_get**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_get) | **GET** /1.0/images/{fingerprint} | Get the image
[**image_get_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_get_untrusted) | **GET** /1.0/images/{fingerprint}?public | Get the public image
[**image_patch**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_patch) | **PATCH** /1.0/images/{fingerprint} | Partially update the image
[**image_put**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#image_put) | **PUT** /1.0/images/{fingerprint} | Update the image
[**images_alias_patch**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_alias_patch) | **PATCH** /1.0/images/aliases/{name} | Partially update the image alias
[**images_alias_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_alias_post) | **POST** /1.0/images/aliases/{name} | Rename the image alias
[**images_aliases_get**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_aliases_get) | **GET** /1.0/images/aliases | Get the image aliases
[**images_aliases_get_recursion1**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_aliases_get_recursion1) | **GET** /1.0/images/aliases?recursion&#x3D;1 | Get the image aliases
[**images_aliases_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_aliases_post) | **POST** /1.0/images/aliases | Add an image alias
[**images_aliases_put**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_aliases_put) | **PUT** /1.0/images/aliases/{name} | Update the image alias
[**images_export_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_export_post) | **POST** /1.0/images/{fingerprint}/export | Make the server push the image to a remote server
[**images_get**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_get) | **GET** /1.0/images | Get the images
[**images_get_recursion1**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_get_recursion1) | **GET** /1.0/images?recursion&#x3D;1 | Get the images
[**images_get_recursion1_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_get_recursion1_untrusted) | **GET** /1.0/images?public&amp;recursion&#x3D;1 | Get the public images
[**images_get_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_get_untrusted) | **GET** /1.0/images?public | Get the public images
[**images_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_post) | **POST** /1.0/images | Add an image
[**images_post_untrusted**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_post_untrusted) | **POST** /1.0/images?public | Add an image
[**images_refresh_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_refresh_post) | **POST** /1.0/images/{fingerprint}/refresh | Refresh an image
[**images_secret_post**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesApi.md#images_secret_post) | **POST** /1.0/images/{fingerprint}/secret | Generate secret for retrieval of the image by an untrusted client
...
[**ImageAliasGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageAliasGet200Response.md)
...
[**ImageGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageGet200Response.md)
...
------------- | ------------- | ------------- | -------------
 **fingerprint** | **str**| Fingerprint | 
 **image** | [**ImagePut**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagePut.md)| Image configuration | 
 **project** | **str**| Project name | [optional] 
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Alias name | 
 **image_alias** | [**ImageAliasesEntryPut**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageAliasesEntryPut.md)| Image alias configuration | 
 **project** | **str**| Project name | [optional] 
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| Alias name | 
 **image_alias** | [**ImageAliasesEntryPost**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageAliasesEntryPost.md)| Image alias rename request | 
 **project** | **str**| Project name | [optional] 
...
[**ImagesAliasesGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesAliasesGet200Response.md)
...
[**ImagesAliasesGetRecursion1200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesAliasesGetRecursion1200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **image_alias** | [**ImageAliasesPost**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageAliasesPost.md)| Image alias | 
 **project** | **str**| Project name | [optional] 
...
------------- | ------------- | ------------- | -------------
 **fingerprint** | **str**| Fingerprint | 
 **image** | [**ImageExportPost**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImageExportPost.md)| Image push request | 
 **project** | **str**| Project name | [optional] 
...
[**ImagesGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesGet200Response.md)
...
[**ImagesGetRecursion1Untrusted200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesGetRecursion1Untrusted200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **image** | [**ImagesPost**](https://github.com/anonhostpi/pyincusd/blob/v7.1.0/docs/ImagesPost.md)| Image | 
 **project** | **str**| Project name | [optional] 
