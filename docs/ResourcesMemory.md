...
**nodes** | [**List[ResourcesMemoryNode]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post14/docs/ResourcesMemoryNode.md) | List of NUMA memory nodes | [optional] 
