...
**nodes** | [**List[ResourcesMemoryNode]**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post18/docs/ResourcesMemoryNode.md) | List of NUMA memory nodes | [optional] 
