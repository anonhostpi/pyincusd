...
------------- | ------------- | -------------
[**metadata_configuration_get**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/DefaultApi.md#metadata_configuration_get) | **GET** /1.0/metadata/configuration | Get the metadata configuration
...
[**MetadataConfigurationGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v6.23.0.post20/docs/MetadataConfigurationGet200Response.md)
